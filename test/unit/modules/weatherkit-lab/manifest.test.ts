...
import manifest from '@/modules/weatherkit-lab';
import type { ModuleManifest } from '@/modules/types';

describe('weatherkit-lab manifest', () => {
  it('has id "weatherkit-lab"', () => {
    expect(manifest.id).toBe('weatherkit-lab');
  });
  ...
  it('declares a weather-evocative SF Symbol icon', () => {
    expect(manifest.icon.ios).toBe('cloud.sun.fill');
