/**
 * Test suite for Sign in with Apple screen (Android).
 */

import React from 'react';
import { render } from '@testing-library/react-native';

import SignInWithAppleScreen from '@/modules/sign-in-with-apple/screen.android';
...
describe('SignInWithAppleScreen (Android)', () => {
  beforeEach(() => {
