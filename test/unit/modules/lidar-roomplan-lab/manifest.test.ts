...
import manifest from '@/modules/lidar-roomplan-lab';
import type { ModuleManifest } from '@/modules/types';

describe('lidar-roomplan-lab manifest', () => {
  it('has id "lidar-roomplan-lab"', () => {
    expect(manifest.id).toBe('lidar-roomplan-lab');
  });
