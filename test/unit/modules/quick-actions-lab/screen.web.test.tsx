/**
 * Quick Actions screen.web tests — banner only, no native bridge call.
...
import QuickActionsLabWebScreen from '@/modules/quick-actions-lab/screen.web';

const qaMock = QA as unknown as { setItems: jest.Mock; addListener: jest.Mock };

describe('QuickActionsLab screen (web)', () => {
  beforeEach(() => {
