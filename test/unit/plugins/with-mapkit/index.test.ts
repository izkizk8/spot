...
describe('with-mapkit', () => {
  ...
  it('coexistence: app.json has the expected plugin shape', () => {
    ...
    // After feature 070, plugins.length should be 43 (added with-icloud-drive after with-coredata-cloudkit)
    expect(plugins.length).toBe(43); // bumped from 42 by feature 070 (with-icloud-drive)
