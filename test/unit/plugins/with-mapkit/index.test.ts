...
describe('with-mapkit', () => {
  ...
  it('coexistence: app.json has the expected plugin shape', () => {
    ...
    // After feature 060, plugins.length should be 43 (added with-visual-look-up after with-coredata-cloudkit)
    expect(plugins.length).toBe(43); // bumped from 42 by feature 060 (with-visual-look-up)
