/**
 * SharePlay Bridge — Web variant (feature 047). All async methods
 * reject with `SharePlayNotSupported`; `isAvailable()` returns
...
const ERR = (): SharePlayNotSupported =>
  new SharePlayNotSupported('SharePlay is not available on Web');
