/**
 * WeatherKit Bridge — Web variant (feature 046). All async methods
 * reject with `WeatherKitNotSupported`; `isAvailable()` returns
 * false. MUST NOT import the iOS bridge file.
 */
...
const ERR = (): WeatherKitNotSupported =>
  new WeatherKitNotSupported('WeatherKit is not available on Web');
