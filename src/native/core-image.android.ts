/**
 * CoreImage Bridge — Android stub (feature 064).
 *
 * CoreImage is iOS-only. All methods reject with
 * `CoreImageNotSupported`. MUST NOT import the iOS variant.
 */
import {
...
const ERR = (): CoreImageNotSupported =>
  new CoreImageNotSupported('CoreImage is not available on Android');
