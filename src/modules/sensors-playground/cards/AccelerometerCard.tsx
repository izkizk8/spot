...
import { BarChart, type XYZ } from '../components/BarChart';
...
export function AccelerometerCard() {
  ...
  // Tick re-render at ~display rate so the chart sees fresh snapshots.
  ...
  return (
    <ThemedView style={styles.card} testID='accelerometer-card'>
      ...
      <BarChart samples={samples} window={30} />
    </ThemedView>
  );
}
