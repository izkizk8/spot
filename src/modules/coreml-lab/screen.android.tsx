/**
 * CoreML Lab screen — Android variant (feature 016).
 *
 * Displays an iOS-only banner with the educational scaffold rendered in
 * disabled mode. No bridge calls; samples remain selectable for visual
 * continuity.
 */
