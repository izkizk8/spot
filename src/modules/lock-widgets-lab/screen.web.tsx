/**
 * Lock Widgets Lab — Web variant (fallback).
 *
 * Web doesn't support Lock Screen widgets. This screen shows the banner,
 * allows config editing (saved to AsyncStorage shadow), and displays previews.
 * Push button is disabled.
 *
 * @see specs/027-lock-screen-widgets/tasks.md T038, T041
 */
