/**
 * ScheduleProcessingCard — feature 030 / T028.
 */
...
interface ScheduleProcessingCardProps {
...
export default function ScheduleProcessingCard({
  status,
  lastRun,
  onSchedule,
  style,
}: ScheduleProcessingCardProps) {
  return (
    <ThemedView style={[styles.container, style]}>
      <ThemedText style={styles.heading}>Processing</ThemedText>
