/**
 * ARKit Lab Screen — Web variant
 * Feature: 034-arkit-basics
 *
 * Same panel structure as Android. MUST NOT import src/native/arkit.ts at
 * module evaluation time (uses platform-resolved arkit.web.ts).
 */
  ...
  return (
    <View style={styles.container}>
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.content}>
        ...
        {/* Panel 2: AR View (IOSOnlyBanner on Web) */}
        ...
        {/* Panel 3: ConfigurationCard (disabled on Web) */}
        <ConfigurationCard
          config={session.config}
          peopleOcclusionSupported={peopleOcclusionSupported}
