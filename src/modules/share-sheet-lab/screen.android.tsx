/**
 * Share Sheet Lab Screen — Android variant.
 * feature 033 / T036.
 *
 * Same as iOS minus AnchorSelector. ExcludedActivitiesPicker and
 * CustomActivityToggle rendered with accessibilityState.disabled === true.
 */
