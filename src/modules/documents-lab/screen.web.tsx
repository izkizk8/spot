/**
 * Documents Lab Screen — Web variant.
 * feature 032 / T046.
 *
 * Structurally identical to the Android variant. MUST NOT import
 * `src/native/quicklook.ts` (iOS path) — uses `quicklook.web.ts` only
 * via Metro's platform-suffixed resolution.
 */
...
export default function DocumentsLabScreenWeb() {
