/**
 * Screen Time Lab — Android fallback variant (FR-010).
 *
 * Renders an "iOS-only" banner and the four-card structure with all
 * action controls disabled. Never invokes any async bridge method.
 */
