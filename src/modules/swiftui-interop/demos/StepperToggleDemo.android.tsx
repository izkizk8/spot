/**
 * @file StepperToggleDemo.android.tsx
 * @description Android RN fallback for StepperToggleDemo (T028)
 * Pressable +/- buttons + RN Switch
 */
...
export function StepperToggleDemo() {
  ...
  return (
    <ThemedView testID="stepper-toggle-demo" style={styles.container}>
      <ThemedText type="smallBold">RN Stepper + Toggle Fallback</ThemedText>
      <ThemedText type="small" themeColor="textSecondary" style={styles.caption}>
        RN fallback: Pressable buttons + Switch
      </ThemedText>
