/**
 * @file SliderDemo.android.tsx
 * @description Android RN fallback for SliderDemo (T027)
 * Segmented chip-based slider
 */
...
export function SliderDemo() {
  ...
  return (
    <ThemedView testID='slider-demo' style={styles.container}>
      <ThemedText type='smallBold'>RN Slider Fallback</ThemedText>
      <ThemedText type='small' themeColor='textSecondary' style={styles.caption}>
        RN fallback: segmented chip row
      </ThemedText>
