/**
 * @file DatePickerDemo.web.tsx
 * @description Web RN fallback for DatePickerDemo (T038)
...
export function DatePickerDemo() {
  ...
  return (
    <ThemedView testID="date-picker-demo" style={styles.container}>
      <ThemedText type="smallBold">Web DatePicker Fallback</ThemedText>
      <ThemedText type="small" themeColor="textSecondary" style={styles.caption}>
        RN-Web fallback: +/- day buttons
      </ThemedText>
