/**
 * Speech Synthesis Lab — Android screen (Phase 9, T065).
 *
 * Same composition as `screen.tsx` minus the PersonalVoiceCard (iOS 17+ only,
 * D-08). The Android JS bridge from `src/native/speech-synthesis.android.ts`
 * supplies the events through `expo-speech`.
 */
...
export default function SpeechSynthesisLabScreenAndroid() {
